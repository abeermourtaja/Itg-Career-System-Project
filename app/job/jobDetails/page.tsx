...
export default function JobDetails() {
    ...
    <div>
        <Navbar></Navbar>
        <div className="w-5/10 mx-auto  py-20">
            ...
            <div className="  rounded-xl border-1 border-[#dfe5ed] p-4   bg-white my-3">
                <div className="flex gap-3 items-start">
                    <div className="rounded-xl size-12 bg-[#e6effb] flex items-center justify-center">
                        <FiBriefcase className="text-[#6a7282] text-xl" />
                    </div>
                    <div className="flex flex-col items-start">
                        <h1 className="font-bold text-xl">Front end developer</h1>
                        <div className="flex text-[#6a7282] items-center gap-4 text-sm">
            ...
            <form action="submit" className="rounded-xl  bg-white border-1 border-[#e5e7eb]">
                ...
                <div className="bg-white p-4">
                    ...
                    <div className="flex gap-5  items-center py-3">
                        <div className="flex flex-col gap-2 w-1/2 ">
                            <label className="font-medium text-[#364153]" htmlFor="email">Country *</label>
                            <div className="flex gap-2 items-center border focus-within:border-blue-500 border-[#e5e7eb] rounded-md p-2">
                                <MdOutlineMail className="text-[#99a1af]" />
                        ...
                        <div className="flex flex-col gap-2 w-1/2">
                            <label className="font-medium text-[#364153]" htmlFor="last-name">Phone Number *</label>
                            <div className="flex gap-2 items-center border focus-within:border-blue-500 border-[#e5e7eb] rounded-md p-2">
                ...
                <div className="mx-3 mb-3">
                    <button type="submit" className= " bg-blue-500 text-white rounded-md hover:bg-blue-600  p-2 font-semibold w-full ">
                    Submit Application
                </button>
                </div>
            </form>
